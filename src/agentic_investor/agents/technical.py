...
indicators, strategy signals, and candlestick patterns for a single stock, and
must classify its near-term stance. Weigh confluence across independent
...
- Volatility: bb_percent_b near 1 rides the upper band, >1 is a breakout, <0
  breaks down; low bb_bandwidth is a squeeze that can precede a move;
  atr_pct is volatility as a share of price.
...
- signals and patterns are already-detected triggers; treat them as evidence
  to weigh, not orders to obey."""
